...
function detalles(datos) {
    console.log("------------------------------");
    console.log();
    console.log("DI: " + datos + " | Orden inverso: " + invertirArray(datos));
    console.log("DI: " + datos + " | Suma de valores: " + sumar(datos));
    console.log("DI: " + datos + " | Datos pares: " + soloPares(datos));
    console.log(
        "DI: " + datos + " | Suma de datos pares: " + sumar(soloPares(datos))
    );
    console.log(
        "DI: " +
        datos +
        " | Los pares del orden inverso: " +
        soloPares(invertirArray(datos))
    );
    console.log(
        "DI: " +
        datos +
    ...
    console.log("* DI: Datos ingresados");
